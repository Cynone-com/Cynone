            ...
            <div wire:click="$set('selectedMethod', 'gateway-{{ $method->id }}')"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        @if($isPayPalPro)
                        <div class="flex flex-wrap gap-2 text-xs font-semibold text-base/70">
                            <span class="rounded-full border border-neutral px-2 py-0.5">Apple Pay</span>
                            <span class="rounded-full border border-neutral px-2 py-0.5">Google Pay</span>
                        </div>
                        <p class="text-sm text-base/50 mt-1">Wallet checkout via PayPal</p>
                        @elseif($isPayPal)
                        <p class="text-sm text-base/50">Classic PayPal checkout</p>
                        @else
